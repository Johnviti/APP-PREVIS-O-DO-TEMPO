  ...
  return (
    ...
    >
      ...
      <animatable.View  delay={800} animation="fadeInUp" style={styles.container}>
        <Text style={styles.textForBallow}>{`Pronto para 
começar?`}</Text>
        <View style={styles.containerForm}>
          <View style={styles.containerTitulo}>
              <Text style={styles.bemVindo}>Bem-vindo!</Text>
              <Text style={styles.text}>
               Verifique a previsao do tempo. Entre agora!
              </Text>
          </View>
          ...
          <View style={styles.buttons}>
              <TouchableOpacity style={styles.buttonEntrar}  onPress={() => navigation.navigate('Home')}>
